...
SETTING_SPECS = {
    ...
    "variant_select": SettingSpec("var", _choice(C.VARIANTS), C.DEFAULT_VARIANT),
    "threshold_kind_select": SettingSpec("thr", _choice(C.THRESHOLD_KINDS), C.DEFAULT_THRESHOLD_KIND),
    "ecod_quantile_slider": SettingSpec("eq", float, C.DEFAULT_ECOD_QUANTILE, C.ECOD_QUANTILE_MIN, C.ECOD_QUANTILE_MAX),
...
PRESET_KEYS = {"n": "n_tours_slider", "p": "p_slider", "n_noise": "n_noise_slider", "n_modes": "n_modes_slider", "curvature": "curvature_slider", "noise": "noise_slider",
               "contamination": "contamination_slider", "kind": "kind_select", "strength": "strength_slider", "variant": "variant_select", "threshold_kind": "threshold_kind_select",
               "ecod_quantile": "ecod_quantile_slider", "quantile": "quantile_slider", "share": "share_slider", "seed": "seed_input"}
# Regler, die je nach Einstellung ausgeblendet sind (Abstand bei "Lücke" und "Korrelationsbruch"; Fisher-Quantil und chi²-Quantil beim erwarteten Anteil; angenommener Anteil bei der Standardschwelle): der Wert bleibt hier erhalten
KEPT = {"strength_slider": "_strength_kept", "ecod_quantile_slider": "_ecod_quantile_kept", "quantile_slider": "_quantile_kept", "share_slider": "_share_kept"}
PRESET_KEPT = {"strength": "_strength_kept", "ecod_quantile": "_ecod_quantile_kept", "quantile": "_quantile_kept", "share": "_share_kept"}
...
def load_permalink_settings():
    ...
    st.session_state["ecod_quantile_slider"] = round(st.session_state.get("ecod_quantile_slider", C.DEFAULT_ECOD_QUANTILE) * 1000) / 1000
